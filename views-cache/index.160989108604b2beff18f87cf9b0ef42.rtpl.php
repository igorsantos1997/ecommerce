					...
					<li>
						...
						<div class="caption-group">
							<h2 class="caption title">
								iPhone <span class="primary">XS <strong></strong></span>
							</h2>
                    ...
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                ...
                                <h2><a href="#">Smartphone LG K51S</a></h2>
                                
                                <div class="product-carousel-price">
                                    <ins>$1099,00</ins> <del>$1199.00</del>
                                </div> 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                ...
                                <h2>Galaxy M51</h2>
                                <div class="product-carousel-price">
                                    <ins>$2.609,10</ins> <del>$2.699,99</del>
                                </div> 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                ...
                                <div class="product-carousel-price">
                                    <ins>$1.619,10</ins> <del>$1.699,90</del>
                                </div>                                 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-carousel-price">
                                    <ins>$3.399,000</ins> <del>$3.599,00</del>
                                </div>                                 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
